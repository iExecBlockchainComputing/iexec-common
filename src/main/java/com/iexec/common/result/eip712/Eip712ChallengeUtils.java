...
public class Eip712ChallengeUtils {
    ...
    static String getDomainSeparator(Eip712Challenge eip712Challenge) {
        ...
        String domainTypesParams = Types.typeParamsToString(eip712Challenge.getDomainTypeParams());
    ...
    static String getMessageHash(Eip712Challenge eip712Challenge) {
        ...
        String messageTypesParams = Types.typeParamsToString(eip712Challenge.getMessageTypeParams());
